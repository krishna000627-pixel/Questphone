...
# ============================================================
#  QuestPhone Push Tool — questphone_v3_7_38_fdroid.zip
#  Token is read from ~/questphone_token (never hardcoded)
#  Usage:
#    ./push_questphone.sh
#    ./push_questphone.sh myfile.zip   <- override zip path
# ============================================================

TOKEN_FILE="$HOME/questphone_token"
GH_USER="krishna000627-pixel"
REPO="Questphone"
DEFAULT_ZIP="questphone_v3_7_38_fdroid.zip"

COMMIT_MSG="fix: today's quests dialog respects start_date — future-scheduled plan quests no longer show before their date — v3.7.33"
...
if [ -f "$ZIP_NAME" ]; then
  ZIP_PATH="$ZIP_NAME"
elif [ -f "/sdcard/Download/$ZIP_NAME" ]; then
