...
class PluginUpkeepWorker @AssistedInject constructor(
    ...
    private data class PluginEconomyEntry(
        ...
        // tier grace period days aren't in every legacy entry; default to spec's standard 3 days
    ...
    override suspend fun doWork(): Result {
        return try {
            ...
            val map = entries.associate { it.packageName to (it.weeklyUpkeep to it.gracePeriodDays) }
