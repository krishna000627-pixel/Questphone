...
class CelestialTheme : BaseTheme {
    ...
    override fun getRootColorScheme(): ColorScheme = lightColorScheme(
        ...
        onError        = Color.White,
        // Unset, this defaults to M3's baseline purple tint, which
        // tonalElevation blends onto every elevated Surface. Invisible on the
        // dark themes (dark-on-dark), but shows up as a visible dark smudge
        // on this light background — hence the black-circle/patch look.
...
class ArcticTheme : BaseTheme {
    ...
    override fun getRootColorScheme(): ColorScheme = lightColorScheme(
        ...
        surfaceVariant = Color(0xFFF0FAFF),
        error          = Color(0xFFDC2626),
        onError        = Color.White,
        surfaceTint    = Color.Transparent
    )
