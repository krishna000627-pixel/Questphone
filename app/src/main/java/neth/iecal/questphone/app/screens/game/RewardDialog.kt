...
@Composable
fun RewardDialogMaker(userRepository: UserRepository, gitHubSyncManager: GitHubSyncManager? = null) {
    ...
    LaunchedEffect(currentDialog) {
        ...
        // Auto-sync after any reward earned
        gitHubSyncManager?.scheduleSync()
    }
