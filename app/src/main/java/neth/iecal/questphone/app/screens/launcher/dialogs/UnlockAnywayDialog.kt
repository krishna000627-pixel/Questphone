    ...
    Row(
        ...
        Card(
            ...
            Column(
                ...
                Text("Earn coins + XP + streak boost", fontSize = 14.sp, color = MaterialTheme.colorScheme.onPrimaryContainer)
        ...
        Card(
            ...
            Column(
                ...
                Text("Lame route", fontSize = 12.sp, color = MaterialTheme.colorScheme.onSurfaceVariant.copy(alpha = 0.6f))
            }
        }
    }
}
