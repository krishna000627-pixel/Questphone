...
sealed class RootRoute(val route: String) {
    ...
    data object NotesList       : RootRoute("notes_list/")
    data object NotesEditor     : RootRoute("notes_editor/")

    // Flashcards app (Anki-like)
    data object DeckList        : RootRoute("flashcards_decks/")
    data object DeckDetail      : RootRoute("flashcards_deck/")
    data object ReviewSession   : RootRoute("flashcards_review/")

    // Onboard/misc
    data object OnBoard         : RootRoute("onboard/")
    data object DebugCentre     : RootRoute("debug_centre/")
    data object TerminalScreen   : RootRoute("terminal_screen/")
    ...
    data object RenderSync            : RootRoute("render_sync/")
    ...
    data object AscensionHall               : RootRoute("ascension_hall/")
    data object RpgSettings                 : RootRoute("rpg_settings/")
    data object PeopleDatabase              : RootRoute("people_database/")
    data object Jarvis                      : RootRoute("jarvis/")

    // My Life — personal life panel
    data object MyLife                      : RootRoute("my_life/")
    data object MyLifeSettings              : RootRoute("my_life_settings/")

    // App Locker & Vault
    data object AppLockerSettings           : RootRoute("app_locker_settings/")
    data object AppVaultSettings            : RootRoute("app_vault_settings/")
    data object CalculatorVault             : RootRoute("calculator_vault/")
    data object PluginStore                 : RootRoute("plugin_store/")
    data object GameBoosterSettings         : RootRoute("game_booster_settings/")
}