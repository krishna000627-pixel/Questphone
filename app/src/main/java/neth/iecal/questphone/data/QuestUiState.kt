...
class QuestInfoState(
    ...
    initialStatReward1: Int = 0,
    initialStatReward2: Int = 0,
    initialStatReward3: Int = 0,
    initialStatReward4: Int = 0
) {
    ...
    var statReward1 by mutableIntStateOf(initialStatReward1)
    var statReward2 by mutableIntStateOf(initialStatReward2)
    var statReward3 by mutableIntStateOf(initialStatReward3)
    var statReward4 by mutableIntStateOf(initialStatReward4)
    inline fun < reified T : Any> toBaseQuest(questInfo: T? = null) = CommonQuestInfo(
        ...
        statReward1 = statReward1,
        statReward2 = statReward2,
        statReward3 = statReward3,
        statReward4 = statReward4
    )
    fun fromBaseQuest(commonQuestInfo: CommonQuestInfo){
        ...
        statReward1 = commonQuestInfo.statReward1
        statReward2 = commonQuestInfo.statReward2
        statReward3 = commonQuestInfo.statReward3
        statReward4 = commonQuestInfo.statReward4
    }
}
