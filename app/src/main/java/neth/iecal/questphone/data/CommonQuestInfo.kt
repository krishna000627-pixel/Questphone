...
data class CommonQuestInfo(
    ...
    /** format yyyy-mm-dd, or "" for no restriction. Quest is hidden from
     *  all "today's active quests" checks until this date is reached —
     *  the mirror-opposite of auto_destruct. Lets a multi-week imported
     *  plan schedule quests to appear in sequence instead of all at once. */
    ...
    var statReward1: Int = 0,
    var statReward2: Int = 0,
    var statReward3: Int = 0,
    var statReward4: Int = 0,
    var category: String = "",          // "Study", "Health", "Personal", "Work", or custom
    @ExcludeFromReviewDialog
    var categoryColor: Long = 0xFF00BCD4, // ARGB color for category badge
    @ExcludeFromReviewDialog
    var completionStreak: Int = 0,      // consecutive days completed
    @ExcludeFromReviewDialog
    var lastStreakDate: String = ""      // last date counted toward completionStreak
)
...
interface QuestDao {
    ...
    @Query("SELECT * FROM CommonQuestInfo")
    suspend fun getAllQuestsAsList(): List<CommonQuestInfo>
