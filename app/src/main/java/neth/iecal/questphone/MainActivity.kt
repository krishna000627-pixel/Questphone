...
import neth.iecal.questphone.app.screens.habitica.HabiticaScreen
import neth.iecal.questphone.app.screens.habitica.AchievementsScreen
import neth.iecal.questphone.app.screens.account.ProfileSettingsScreen
import neth.iecal.questphone.app.screens.etc.CloudSyncScreen
            ...
            LauncherTheme(currentTheme.value) {
                Surface {
                    ...
                    NavHost(
                        ...
                        composable(RootRoute.HabiticaScreen.route) {
                            HabiticaScreen(navController)
                        }
                        composable(RootRoute.AchievementsScreen.route) {
                            AchievementsScreen(navController)
                        }
                        composable(RootRoute.ProfileSettings.route) {
                            ProfileSettingsScreen(navController)
                        }
                        composable(RootRoute.CloudSync.route) {
                            CloudSyncScreen(navController)
                        }
                    }
