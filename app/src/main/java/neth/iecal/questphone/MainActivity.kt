            ...
            LauncherTheme(currentTheme.value) {
                Surface {
                    ...
                    NavHost(
                        ...
                        composable(RootRoute.Routines.route) {
                            neth.iecal.questphone.app.screens.routine.RoutineScreen(navController)
                        }
                        composable(RootRoute.DataVault.route) {
                            neth.iecal.questphone.app.screens.vault.DataVaultScreen(navController)
                        }
                    }
