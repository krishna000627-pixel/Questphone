...
class UserRepository @Inject constructor(
    ...
    fun clearStockHoldings() {
        userInfo.stockHoldings.clear()
        saveUserInfo()
    }

    fun getTransactionHistory() = getTradingTransactions()

    fun deductCoins(amount: Int, reason: String = "") {
        userInfo.coins -= amount
        coinsState.value -= amount
        CoinTransactionLogger.record(context, -amount, reason)
        saveUserInfo()
    }
