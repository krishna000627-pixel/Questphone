...
data class UserInfo constructor(
    ...
    // ── Habitica merger fields ──────────────────────────────────────
    var habiticaTasks: MutableList<HabiticaTask> = mutableListOf(),
    var habiticaPets: MutableList<HabiticaPet> = mutableListOf(),
    var diamonds: Int = 0,             // premium currency for Full Free Day
    var bossFight: BossFight? = null,
    var customAchievements: MutableList<CustomAchievement> = mutableListOf(),
    var statPoints: StatPoints = StatPoints(),
    var statPointsToAllocate: Int = 0,

    // ── Profile fields ──────────────────────────────────────────────
    var profileType: String = "school",  // school | college | work
    var profileClass: String = "",       // e.g. "12th PCM"
    var profileSkills: String = "",      // e.g. "AI Prompt Engineering"
    var profileDob: String = "",         // e.g. "18/03/11"
    ...
    var coinToMinuteRatio: Int = 100,   // 100 coins = 1 min free time
