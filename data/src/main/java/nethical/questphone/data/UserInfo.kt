...
data class UserInfo constructor(
    ...
    // -- Bank & Loan System ------------------------------------------------
    var loanAmount: Int = 0,                        // active loan principal in GC
    var loanRepaidAmount: Int = 0,                  // how much repaid so far
    var loanTakenDate: String = "",                 // ISO date string
    var loanDueDate: String = "",                   // ISO date string (7 days after taken)
    var loanInterestRate: Float = 0.05f,            // 5% daily interest after due date
    var loanPenaltyDays: Int = 0,                   // days overdue

    // Paper trading portfolio: stockSymbol -> Holdings
