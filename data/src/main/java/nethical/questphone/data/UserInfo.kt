...
data class UserInfo constructor(
    ...
    // -- Game Booster Plugin -----------------------------------------------
    var gameBoosterPackage: String = "",           // "" = none selected; else the plugin app pkg
    var gameApps: MutableSet<String> = mutableSetOf(), // packages hidden from drawer, shown inside Game Booster
